...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        {
          title:
            "Shraddha Care Taker Nursing & Maid Services — Patient Care at Home, Nagpur",
        },
        {
          name: "description",
          content:
            "Premium 24-hour nursing, elderly care, baby care and maid services at home in Nagpur. Trained ANM/GNM sisters, ward boys, attendants and maids.",
        },
